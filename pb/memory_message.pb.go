...
type Memory struct {
	...
	Uint  Memory_Uint `protobuf:"varint,2,opt,name=uint,proto3,enum=pcbook.Memory_Uint" json:"uint,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x69,
	0x6e, 0x74, 0x52, 0x04, 0x75, 0x69, 0x6e, 0x74, 0x22, 0x5e, 0x0a, 0x04, 0x55, 0x69, 0x6e, 0x74,
	...
	0x52, 0x41, 0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x26, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x65, 0x70, 0x68, 0x7a, 0x33, 0x6e, 0x74, 0x2e, 0x70,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Uint)(0), // 0: pcbook.Memory.Uint
	(*Memory)(nil),   // 1: pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: pcbook.Memory.uint:type_name -> pcbook.Memory.Uint
